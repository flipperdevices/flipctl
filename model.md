...
The service acts as the **single data source** for all View implementations (HW, Web, TUI) and drives task execution through the `AppWrapper`.
...
> See: [Example of plugin](model-pugin.md)
